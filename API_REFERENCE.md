...
- `avgSpeedKmh` (Double, optional): toc do trung binh.
- `maxSpeedKmh` (Double, optional): toc do toi da.
- `stepCount` (Integer, optional): tong so buoc chan cua workout.
- `avgHeartRate` (Integer, optional): nhip tim trung binh.
